...
In your `styles` directory , create a directory named `emotion/index` and inside we start by  creating a card component. Ensure to import `emotion module` before creating your component.
