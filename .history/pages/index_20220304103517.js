...
import { Black, Button, Details, FormContainer, Input, Inputs, Label, Blue, Card, Card_1, Card_2, ColorGrid, Container, Dots, Green, Pink, Red1, Red2, Templates, Text, Title, TitleContainer, Yellow, FinalCardContainer, FinalCard } from "../styles/emotion";
...
export default function Home() {
  ...
  // document.getElementById("finalcard").style.backgroundImage = `url(${bg1})`;
  }
  return (
    <>
      <TitleContainer>
      ...
      <Container>
        {selectedtemplate ?
          <Details>
              ...
              <FinalCardContainer id="finalcard">
                  <FinalCard>
