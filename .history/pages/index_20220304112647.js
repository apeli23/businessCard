...
import { Black, Button, Details, FormContainer, Input, Inputs, Label, Blue, Card, Card_1, Card_2, ColorGrid, Container, Dots, Green, Pink, Red1, Red2, Templates, Text, Title, TitleContainer, Yellow, FinalCardContainer, CardFront, InfoGrid, NameTag, CardBack, Name } from "../styles/emotion";
        ...
        {selectedtemplate ?
          <Details>
            ...
            <FinalCardContainer >
              <CardFront id="front">
                <InfoGrid>
                  <Name>{name ? props.name : 'Your Name'}</Name>
                </InfoGrid>
              </CardFront>
