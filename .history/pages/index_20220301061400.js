...
export default function Home() {
  ...
  async function uploadHandler() {
    setOtherTrial(true);
    const finalcard = document.getElementById("card")
    // console.log(finalcard);
    const card = takeScreenshot(finalcard);
    // console.log(card)
    // if (!card) return;
    // console.log(card);
  }
      ...
      <Container>
        <div onClick={template1Handler}>
          {selectcard2 ? (
            ...
            <>
              <div><Card_1 id="card" props={props} uploadstatus={uploadstatus} ref={cardRef} /></div>
