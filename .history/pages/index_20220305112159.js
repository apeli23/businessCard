...
export default function Home() {
  ...
  const testHandler = async () => {
    ...
    let height = cnv.setAttribute("height", 220)
    let width = cnv.setAttribute("width", 390)
    let context = cnv.getContext("2d")

    let imageObj = new Image();
    imageObj.src = "https://res.cloudinary.com/dogjmmett/image/upload/v1646463719/b64jnyes9eumrhvtuo1k.png";
    console.log(imageObj);

   cnv.onload = function(){
      context.drawImage(imageObj, cnv.height, cnv.width);
      context.font = "40pt Calibri";
      context.fillText("My TEXT!", 20, 20);
  }
  console.log(cnv.toDataURL("png"))
