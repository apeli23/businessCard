...
import { Black, Button, Details, FormContainer, Contain, Input, Inputs, Label, Blue, Card, Card_1, Card_2, ColorGrid, Container, Green, Red1, Red2, Templates, Text, Title, TitleContainer, Yellow, FinalCardContainer, Front, InfoGrid, NameTag, Back, Name, Brand, CardText, Address, PhoneNumber, Email, TextLg, TextSm, UploadButto, Backn, UploadButton, Grid } from "../styles/emotion";
...
export default function Home() {
  ...
  <Card2 ref={refTwo} id="card" onClick={card2Handler}>
        ...
        {selectedtemplate == true ?
          <Details>
            ...
            {selectedcard === "card1" ?
              ...
              </FinalCardContainer> : selectedcard == "card2" ?
                "card2"
                : ""
            }
          </Details>
