...
import { Black, Button, Details, FormContainer, Contain, Input, Inputs, Label, Blue, Card, Card_1, Card_2, ColorGrid, Container, Green, Pink, Red1, Red2, Templates, Text, Title, TitleContainer, Yellow, FinalCardContainer, Front, InfoGrid, NameTag, Back, Name, Brand, CardText, Address, PhoneNumber, Email, TextLg, TextSm, UploadButto, Backn, UploadButton, Grid } from "../styles/emotion";
