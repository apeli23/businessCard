...
In your `styles` directory , create a directory named `emotion/card1` and inside we start by  creating a card component. Ensure to import `emotion module` before creating your component.
