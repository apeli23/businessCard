...
There can be several ideas respoective of the developer on how information in the card can be displayed. In our case we will build an app that captures the template above and stores it online for future display as well as demonstrate an example of using such a card thoug