...
After a template is selected, the background will be uploaded to cloudinary and imported to the `final card` as a background. The `information grid can then be appended to this background. Use the code below to create y
