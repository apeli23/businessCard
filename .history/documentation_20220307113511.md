...
For a clearer picture of what we just did import the color components in side the `index` directory and include them in your `ColorGrid`. Your final card component should 